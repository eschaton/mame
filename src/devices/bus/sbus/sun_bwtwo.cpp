...
sun_bwtwo_device::sun_bwtwo_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, uint32_t clock)
...
sun_bwtwo_device::sun_bwtwo_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock)
	: sun_bwtwo_device(mconfig, SUN_BWTWO, tag, owner, clock)
{
}
